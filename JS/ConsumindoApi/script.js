...
function nutriApp(){
    ...
    .catch(() => {
        let testeError = document.createElement("p");
        let textError = document.createTextNode('Ocorreu algum erro.');

        testeError.appendChild(textError);
        listElement.appendChild(testeError);
