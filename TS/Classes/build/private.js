...
class Conta {
    constructor() {
        this.limite = 500; // private significa que o atributo só pode ser acessado dentro da própria classe
    }
    ...
    solicitarLimite(valor) {
        return this.aumentarLimite(valor);
    }
    solicitarLimiteApp(estaAutenticado, valor) {
        if (estaAutenticado) {
