...
function repositorio <T extends string | number>(){
    ...
    function setDados(dadosRecebidos: T) {
...
const repo3 = repositorio<boolean>(); // Erro de compilação, pois boolean não é permitido

const repo4 = repositorio<string | number>();
